...
players.each do |play|
  data = play.data.where(gameName: 'Tenacity-Meditation', key: 'TenSelfAssessment').asc(:timestamp)
  if data.count > 0
    ...
    CSV.open("csv/tenacity/tenacity_assessment_"+play.email+".csv", "w") do |csv|
